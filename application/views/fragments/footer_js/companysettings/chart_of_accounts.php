...
<script>
		...
		columns: [
					...
					{'data': 'lvl_1_code'},
					{
                        mRender: function(row, setting, full){
                            if(full.status === '1'){
                                return full.lvl_1_name + "<button class='btn btn-raised btn-default btn-xs next-level show-lvl-2' title='Show Classification'><i class='fa fa-angle-right'></i></button>";
                            }
                            return full.lvl_1_name + "<button class='btn btn-raised btn-default btn-xs next-level' title='Show Classification'><i class='fa fa-angle-right'></i></button>";
                        }
                    },
				],
	...
	var acc_classification = $('#account-classification').DataTable({
		...
		columns: [
					...
					{'data': 'lvl_2_code'},
					{
                        mRender: function(row, setting, full){
                            if(full.lvl_2_status === '1'){
                                return "<button class='btn btn-raised btn-default btn-xs prev-level show-lvl-1' title='Show Element'><i class='fa fa-angle-left'></i></button>" + full.lvl_2_name + "<button class='btn btn-raised btn-default btn-xs next-level show-lvl-3' title='Show Line Items'><i class='fa fa-angle-right'></i></button>";
                            }
                            return "<button class='btn btn-raised btn-default btn-xs prev-level show-lvl-1' title='Show Element'><i class='fa fa-angle-left'></i></button>" + full.lvl_2_name + "<button class='btn btn-raised btn-default btn-xs next-level' title='Show Line Items'><i class='fa fa-angle-right'></i></button>";
                        }
                    },
				],
	...
	var line_items = $('#line-items').DataTable({
		...
		columns: [
					...
					{'data': 'lvl_3_code'},
					{
                        mRender: function(row, setting, full){
                            if(full.lvl_3_status === '1'){
                                return "<button class='btn btn-raised btn-default btn-xs prev-level show-lvl-2' title='Show Classification'><i class='fa fa-angle-left'></i></button>" + full.lvl_3_name + "<button class='btn btn-raised btn-default btn-xs next-level show-lvl-4' title='Show SubClassification'><i class='fa fa-angle-right'></i></button>";
                            }
                            return "<button class='btn btn-raised btn-default btn-xs prev-level show-lvl-2' title='Show Classification'><i class='fa fa-angle-left'></i></button>" + full.lvl_3_name + "<button class='btn btn-raised btn-default btn-xs next-level' title='Show SubClassification'><i class='fa fa-angle-right'></i></button>";
                        }
                    }
				],
	...
	var account_subclassification = $('#account-subclassification').DataTable({
		...
		columns: [
					...
					{'data': 'lvl_4_code'},
					{
                        mRender: function(row, setting, full){
                            if(full.lvl_4_status === '1'){
                                return "<button class='btn btn-raised btn-default btn-xs prev-level show-lvl-3' title='Show Line Item'><i class='fa fa-angle-left'></i></button>" + full.lvl_4_name;
	...
	var lvl_5 = $('#lvl5-table').DataTable({
		...
		columns: [
					...
					{
                        mRender: function(row, setting, full){
                            return "<button class='btn btn-raised btn-default btn-xs prev-level show-lvl-4' title='Show SubClassification'><i class='fa fa-angle-left'></i></button>" + full.lvl_5_name;
                        }
                    },
				],
	...
	$('#add-lvl-5').click(function(){
		...
		$(this).popover({
			...
			callback: function(){
				...
				$('#lvl-5-add-acc-sub').val(lvl_4_id);
				$('#lvl-5-add-acc-sub').selectize({
					create: false,
					sortField: {
						field: 'text',
						direction: 'asc'
	...
	$('#lvl5-table').on('click', 'button.view', function(){
		...
		$(this).popover({
			...
			callback: function(){
				...
				$('#lvl-5-view-acc-sub').val(data.lvl_4_id);
				$('#lvl-5-view-acc-sub').selectize({
					create: false,
					sortField: {
						field: 'text',
						direction: 'asc'
	...
	$('#lvl5-table').on('click', 'button.edit', function(){
		...
		$(this).popover({
			...
			callback: function(){
				...
				$('#lvl-5-edit-acc-sub').val(lvl_4_id);
				$('#lvl-5-edit-acc-sub').selectize({
					create: false,
					sortField: {
						field: 'text',
						direction: 'asc'
	...
	$('#lvl5-table').on('click', 'button.delete', function(){
		...
		$(this).popover({
			...
			callback: function(){
				...
				$('#lvl-5-delete-acc-sub').val(data.lvl_4_id);
				$('#lvl-5-delete-acc-sub').selectize({
					create: false,
					sortField: {
						field: 'text',
						direction: 'asc'
	...
	$('#add-coa-temporary').click(function(){
		...
		$(this).popover({
			...
			callback: function(){
				...
				var lvl5 = $('#add-coa-lvl-5').selectize({
					create: false,
					sortField: {
						field: 'text',
						sort: 'asc'
					...
					onChange: function(value){
						...
						var selectize = $('#add-coa-lvl-5').selectize()[0].selectize;
				...
				var subclass = $('#add-subclassification').selectize({
					create: false,
					sortField: {
						field: 'text',
						sort: 'asc'
					...
					onChange: function(value){
						var value = value ? value : 0;
						var selectize = $('#add-subclassification').selectize()[0].selectize;
						var selected = selectize.options[value] ? selectize.options[value] : '';
						var code = selected !== '' ? selected.code : '';
				...
				var lineitem = $('#add-line-item').selectize({
					create: false,
					sortField: {
						field: 'text',
						sort: 'asc'
					...
					onChange: function(value){
						var value = value ? value : 0;
						var selectize = $('#add-line-item').selectize()[0].selectize;
						var selected = selectize.options[value] ? selectize.options[value] : '';
						var code = selected !== '' ? selected.code : '';
				...
				var classification = $('#add-classification').selectize({
					create: false,
					sortField: {
						field: 'text',
						sort: 'asc'
					...
					onChange: function(value){
						var value = value ? value : 0;
						var selectize = $('#add-classification').selectize()[0].selectize;
						var selected = selectize.options[value] ? selectize.options[value] : '';
						var code = selected !== '' ? selected.code : '';
				...
				var element = $('#add-element').selectize({
					create: false,
					sortField: {
						field: 'text',
						sort: 'asc'
					...
					onChange: function(value){
						var value = value ? value : 0;
						var selectize = $('#add-element').selectize()[0].selectize;
						var selected = selectize.options[value] ? selectize.options[value] : '';
						var code = selected !== '' ? selected.code : '';

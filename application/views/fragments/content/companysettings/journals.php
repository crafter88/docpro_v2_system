			...
			<div class='row'>
				<div class='col-md-12'>
					<div class='col-md-12' id='journals-table-row' style="padding: 0;">
						<button id='add' type='button' class='btn btn-info btn-sm btn-raised ripple-effect' <?php if($user->main_company->cb_id !== $user->cb_id){ echo 'disabled'; } ?> style='display: none;'><i class='fa fa-plus'></i></button>

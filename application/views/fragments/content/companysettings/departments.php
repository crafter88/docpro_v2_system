			...
			<div id='custom-card-title' class='row' style="margin: 30px 0 0 0; text-align: center;">
				<div class='panel panel-default' style="border: none; border-bottom: 2px solid #000">
					<div class='panel-body'>
						<p style="font-size: 24px; margin: 0;">Departments</p>
					</div>
				</div>
			</div>
			<div class='row'>
...
<div id='update-popover' class='modal fade' role='dialog' tabindex='-1'>
	...
	<form action='<?php echo base_url(); ?>company_settings/departments/update' method='post' class='body'>
		...
		<div class='modal-footer' style='border-top: 1px inset; padding-top: 5px; padding-bottom: 0px;'>
			<button class='btn btn-info btn-sm btn-raised ripple-effect v-submit' type='button' data-dismiss='modal' style='right: left;'>OK</button>
		</div>
	</form>
</div>